...
public class Numbers {
	...
	public static void addingDigits() {
		...
		num = num / 10;
		int y = x + num;
		System.out.println("\nThe added digits of number typed are = " + y + "! \n");
	}
	...
	public static void numberToWord(int num) {
        ...
        System.out.println("Number to word = " + oneToNineteen[num] + "!");	
 ...
 * 
 * Create a method that when given the number 1-99 returns a String
